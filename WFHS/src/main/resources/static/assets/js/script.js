...
/* function showDetails(customer, orderDate, status, amount) {
  // Set details in the modal
  document.getElementById("modalCustomer").innerText = "Customer: " + customer;
  document.getElementById("modalOrderDate").innerText = "Order Date: " + orderDate;
